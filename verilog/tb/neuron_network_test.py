    ...
    for core_layer_0 in range (NUM_CORES_LAYER_0): #
        ...
        for row_i in range(32):
            for col_i in range(32):
                ...
                val_slice = connection_layer_0[axon][NUM_NEURONS_LAYER_0 - (neuron + 16):NUM_NEURONS_LAYER_0 - neuron]                
    ...
    for core_layer_1 in range (NUM_CORES_LAYER_1): #
        ...
        for row_i in range(32):
            for col_i in range(32):
                ...
                val_slice = connection_layer_1[axon][NUM_NEURONS_LAYER_1 - (neuron + 16):NUM_NEURONS_LAYER_1 - neuron]                
                int_val = list_to_binary(val_slice)
    ...
    for core_layer_2 in range (NUM_CORES_LAYER_2): #
        ...
        for row_i in range(32):
            for col_i in range(32):
                ...
                val_slice = connection_layer_2[axon][NUM_NEURONS_LAYER_2 - (neuron + 16):NUM_NEURONS_LAYER_2 - neuron]                
                int_val = list_to_binary(val_slice)
